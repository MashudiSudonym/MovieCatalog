...
@Entity(tableName = "content_movie_search_table")
data class ContentMovieSearchEntity constructor(
...
fun List<ContentMovieSearchEntity>.asDomainModel(): List<ContentResult> {
    return map {
        ContentResult(
